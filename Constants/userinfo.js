...
export const userinfo = {
  ...
  socials: [
    {
      type: "facebook",
      link: "https://www.facebook.com/profile.php?id=1390464755",
      icon: faFacebook,
    },
    {
      type: "spotify",
  ...
  aboutSeeMore: {
    content: `<p>Michael “Mudcat” Ward has been a key player in the New England blues scene for over forty years. His signature traditionally-grounded approach and tone, both on the acoustic upright bass and on Fender bass, have gracefully supported many a roots artist over the years, whether in the recording studio, in clubs, theaters, outdoor venues, or on television broadcasts or film.<br>
        ...
        During the mid 1990’s, Ward held the bass chair with Magic Dick and the late Jay Geils (of J. Geils rock band fame) in their traditional blues-band project, called Bluestime, a position Ward held for four years. As a part of Bluestime, Ward composed and recorded the band theme, toured the US and Japan, recorded two studio CD’s, and had been featured on two summer tours of action with B.B. King, Etta James, Robert Cray and Jimmy Vaughan. He also played upright bass on a guitar instructional video tape guitarist Geils made for Hot Licks productions.<br>
        ...
        A list of musicians Michael “Mudcat” Ward has performed with by any account is long and probably incomplete. Such a listing would need to include:<br>
